function synthesize(figName, Niter, initImgName)
    ...
    initImg = imread(strcat('/mnt/ceph/users/wbroderick/plenoptic_experiments/ps_relative_l2_vs_matlab/init_images/', initImgName, '.png'));
    ...
    save(strcat('/mnt/ceph/users/wbroderick/plenoptic_experiments/ps_relative_l2_vs_matlab/matlab_results/', figName, "_", initImgName, "_iter-", string(Niter), '.mat'), "res", "initToc", "synthToc")
end
