...
images = ["macaque"]
init_style = ["full"]
for s, sch, o, loss, l, lay, img, init in itertools.product(seeds, scheduler, optimizer, loss_func, lr, layer, images, init_style):
    outfile = base_out / f"model-ResNet50-{lay}_img-{img}_init-{init}_{device}_seed-{s}_iter-{it}_loss-{loss}_opt-{o}_lr-{l:.1e}_sch-{sch}.pt"
